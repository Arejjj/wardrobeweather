export const translations = {
  en: {
    ...
    formColor: 'Color',
    formColorPlaceholder: 'e.g. Navy Blue',
    formPhoto: 'Photo',
    formPhotoChosen: '✓ Photo selected',
    formPhotoUpload: 'Upload photo',
    formScan: 'Scan with AI',
    formScanning: 'Analysing your item…',
    formScanFailed: "Couldn't read the image — please fill in manually.",
    scanPickerHint: (n) => `Found ${n} items — select which to add:`,
    scanPickerAdd: (n) => n === 1 ? 'Add 1 item' : `Add ${n} items`,
    scanPickerEdit: 'Edit',
    formTempMin: 'Min. temp (°C)',
    formTempMax: 'Max. temp (°C)',
  ...
  de: {
    ...
    formColor: 'Farbe',
    formColorPlaceholder: 'z.B. Marineblau',
    formPhoto: 'Foto',
    formPhotoChosen: '✓ Foto gewählt',
    formPhotoUpload: 'Foto hochladen',
    formScan: 'Mit KI scannen',
    formScanning: 'Kleidungsstück wird analysiert…',
    formScanFailed: 'Bild konnte nicht erkannt werden — bitte manuell ausfüllen.',
    scanPickerHint: (n) => `${n} Kleidungsstücke erkannt — wähle aus, was du hinzufügen möchtest:`,
    scanPickerAdd: (n) => n === 1 ? '1 Stück hinzufügen' : `${n} Stücke hinzufügen`,
    scanPickerEdit: 'Bearbeiten',
    formTempMin: 'Min. Temp. (°C)',
    formTempMax: 'Max. Temp. (°C)',
